...
public class Waiter implements Runnable{
    ...
    public void run() {
        ...
        synchronized (missatge) {
            try{
                System.out.println(name + ": abans del wait(), hora = " + System.currentTimeMillis());
                
                missatge.wait();
                
                System.out.println(name + ": després del wait(). Hem rebut un notify(). Hora = " + System.currentTimeMillis());
